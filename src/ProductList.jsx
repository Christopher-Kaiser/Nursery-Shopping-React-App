...
function ProductList({ onHomeClick }) {
    ...
    // Calculate total cart quantity using Redux store
        ...
        <div>
            <div className="navbar">
                ...
                <div className="navbar-center">
                    <div> <a href="#" onClick={(e) => handlePlantsClick(e)} className="navbar-link">Plants</a></div>
                </div>
                                ...
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                if (!isInCart(plant.name)) handleAddToCart(plant);
                                            }}
